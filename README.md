...
Esse projeto tem como objetivo servir como base para novos projetos front-end que venham surgir na positivo.
...
- [design-system](https://gitlab.com/positivote/hub-educacional/front-end/design-system) - Para componentização padronizada com o Figma;
