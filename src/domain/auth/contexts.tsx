...
import { MANAGER_PERMISSION_KEYS } from '@/common/constants'
...
import { UserRole, UserWithoutPasswordFormatted } from '@/domain/user/contracts'
...
export function AuthProvider({ children }: { children: React.ReactNode }): JSX.Element {
  const { handleError } = useErrorHandler({ ignoreSignOut: true })
  ...
  const showSession = useCallback(
    ...
    [handleError, setStateSafety, signOut],
  )
