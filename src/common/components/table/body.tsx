...
import {
  FormCancelButton as CancelButton,
  FormConfirmButton as ConfirmButton,
  FormGridContainer,
} from '@/common/components/Form'
import { ActionFunction, CheckBoxProps, ColumnInfo } from '@/common/components/Table'
      ...
      >
        ...
        <DialogContent>
          ...
          <FormGridContainer spacing={2} sx={{ marginTop: '0.5rem' }}>
            <ConfirmButton onClick={handleConfirmAction} gridProps={{ xs: 6 }}>
              {i18n().common.components.table.body.confirm}
            </ConfirmButton>
            <CancelButton onClick={handleCancelAction} gridProps={{ xs: 6 }}>
